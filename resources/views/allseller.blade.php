...
<html lang="en">
  ...
  <body>
    ...
    .heading{
        color: #454545;font-size:64px;font-weight:900;line-height:60px"
    }
    .storet2{
        color: #454545;font-size:24px;font-weight:400;line-height:30px;
    }
    .bset_sel_t1{
        color: #454545;font-size:64px;font-weight:900;line-height:80px;
    }
    .bset_sel_t2{
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-7 text-left" id="main_banner_text">
                    <div class="main_bannert1">
                        <span>Find The Best Product Item For You</span>
                    </div>
                    <div class="main_bannert2">
    ...
    <section style="margin-top:50px" id="gb1">
        <div class="container">
            <div class="row text-center">
                {{-- <img src="{{ asset('public/img/Ellipse.png')}}" alt="" height="500px"> --}}

                    <div class="col-12 heading">
                        New In Store
                    </div>
                    <div class="col-12 storet2">
    ...
    <section  style="margin-top:50px" id="gb2">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ asset('public/img/girlimg.png')}}" alt="" width="500px" height="600px">
                </div>
                <div class="col-md-6">
                    <div class=" text-left">
                        <div class="">
                            <div class="ep_t1"> Best Seller Product Sale & EASY Payment Services.</div><br/><br/>
                            <div class="ep_t2">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.duis enim velit mollit. Exercitation veniam consequat sunt nostrud amet.</div>
        ...
        <div class="container" style="border:2px solid #636363">
            <div class="row mt-5 mb-5">
                <div class="col-xl-6 col-lg-7 text-left">
                    <div class="bset_sel_t1 mt-2">Best Seller</div>
    ...
    <section class="mb-4" style="margin-top:50px">
        <div class="container">
            <div class="row text-center">
                ...
                <img src="{{ asset('public/img/Vector.png')}}" alt="" style="margin-left:1100px;" width="12%">
                ...
                <img src="{{ asset('public/img/right.png')}}" alt="" style="margin-left:1050px;margin-top:-100px" width="12%">
        </div>
        {{ $shops->links() }}
    </section>
